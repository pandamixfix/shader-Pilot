...
import { Slider, AiStage, SliderSuggestion, TerraformConfig, TerraformTarget, ControlConfig, SoundConfig, Modulation, CameraData, ViewMode, ShipConfig, ShipModulation, Enemy, Projectile, PlayerStats, WeaponType } from '../types';
...
export interface AppContextType {
  ...
  buyUpgrade: (type: keyof PlayerStats['upgrades']) => void;
